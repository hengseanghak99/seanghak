  ...
  return (
    <div className="flex flex-col h-screen py-10">
      ...
      <div className="grid place-items-center mx-2 my-20 sm:my-auto">
        {/* Contact Us Card */}
        <div className="w-11/12 p-12 sm:w-8/12 md:w-6/12 lg:w-5/12 2xl:w-4/12 px-6 py-10 sm:px-10 sm:py-6 border-2 border-white-500 rounded-lg shadow-md lg:shadow-lg">
          {/* Card Title */}
