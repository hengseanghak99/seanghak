...
function Home() {
  return (
    <>
      ...
      <section class="font-mono px-4 text-gray-300">
  <h2 class="text-2xl font-bold mb-4">About Me</h2>

  <div class="mb-6">
    <p class="text-base md:text-lg lg:text-xl">  Hi everyone, I'm Heng Seanghak, a QA Tester from Kompong Cham, Cambodia. With 3 years of experience, I specialize in both automated and manual software testing. I've tested software for the government (EDC, SWMA, Siem Reap government) and various overseas projects. I am skilled in using automated testing tools like Ranorex and Playwright and have some experience in web and mobile development. I also enjoy coding and am currently learning to be a Full Stack Developer. I'm passionate about my work and eager to keep learning!
    </p>
    <h2 class="text-2xl  mt-8 mb-4 underline">Technical Skills</h2>
    <ul class="list-disc list-inside pl-4 md:pl-6 lg:pl-8"> <li>Testing: Manual & Automation (Playwright, Ranorex, JMeter, Postman)</li>
    ...
    <ul class="list-disc list-inside pl-4 md:pl-6 lg:pl-8"> <li>Problem Solving & Analytical Thinking</li>
    ...
    <ul class="list-disc list-inside pl-4 md:pl-6 lg:pl-8"> <li>I've some knowledge about:</li>
