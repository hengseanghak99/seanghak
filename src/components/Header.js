      ...
      >
        <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0">
          <li className="hover:border-solid hover:border-2 hover:border-amber-400 rounded">
            <a
              href="/"
              className="block py-2 px-3 text-gray-900 rounded hover:bg-yellow-500 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-amber-300 dark:hover:text-white md:dark:hover:bg-transparent md:text-4xl"
            >
              Portfolio
            </a>
          </li>
